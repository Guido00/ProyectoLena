...
public class IPantallaNuevaLocalidad extends javax.swing.JDialog {

    private final RepositorioLocalidad rl;

    public IPantallaNuevaLocalidad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jTextFieldLocalidad.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        jLabel3.setText("*El Código Postal no es obligatorio");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextFieldCP, javax.swing.GroupLayout.DEFAULT_SIZE, 282, Short.MAX_VALUE))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        rl.guardar(new Localidad(jTextFieldLocalidad.getText(), jTextFieldCP.getText()));        
